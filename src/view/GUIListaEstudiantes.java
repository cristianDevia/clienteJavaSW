 ...
 * @author Estudiantes
 */
public class GUIListaEstudiantes extends javax.swing.JFrame {
     ...
     */
    public GUIListaEstudiantes(GUIAgregarMatricula matricula)
    {
        agregar = matricula;
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        ...
        String cedula = grilla1.getModel().getValueAt(row, 1).toString();
        String codigo = grilla1.getModel().getValueAt(row, 2).toString();
        agregar.setDatos(cedula, codigo);
        this.dispose();
