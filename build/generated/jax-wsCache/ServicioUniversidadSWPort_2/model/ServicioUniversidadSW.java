...
public interface ServicioUniversidadSW {
     ...
     * 
     * @return
     *     returns java.util.List<model.ProgramaAcademico>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getProgramas", targetNamespace = "http://model/", className = "model.GetProgramas")
    @ResponseWrapper(localName = "getProgramasResponse", targetNamespace = "http://model/", className = "model.GetProgramasResponse")
    @Action(input = "http://model/ServicioUniversidadSW/getProgramasRequest", output = "http://model/ServicioUniversidadSW/getProgramasResponse")
